...
//This encrypted a dll file so it generated random keys and then saved them PRNG is used to create these keys. But we just wanna do that once and then save it and use it everywhere :)
