...
//Encrypts std::string for auth and other important services
...
LIBNP_API NPAsync<NPValidateUserTicketResult>* LIBNP_CALL NP_ValidateUserTicket(const void* ticket, size_t ticketSize, uint32_t clientIP, NPID clientID, const char* name);
