...
#define NUM_RPC_MESSAGE_TYPES 34 
...
class RPCFriendsRequestRoster : public INPRPCMessage
{
private:
	NPRPCBuffer<FriendsRequestRoster> _buffer;
	
	uint8_t* _payload;
public:
	RPCFriendsRequestRoster()
	{
		_payload = NULL;
	}
	...
	FriendsRequestRoster* GetBuffer();
	...
	virtual void Free();
	virtual void FreePayload();
	static RPCFriendsRequestRoster* Create();
};
