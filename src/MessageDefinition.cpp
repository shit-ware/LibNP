...
FriendsRequestRoster* RPCFriendsRequestRoster::GetBuffer()
{
	return _buffer.GetPayload();
}

void RPCFriendsRequestRoster::Deserialize(const uint8_t* message, size_t length)
{
	_buffer.Deserialize(message, length);
}

uint8_t* RPCFriendsRequestRoster::Serialize(size_t* length, uint32_t id)
{
	if (_payload)
	{
		return _payload;
...
int RPCFriendsRequestRoster::GetType()
{
	return 1202;
}

void RPCFriendsRequestRoster::Free()
{
	if (_payload != NULL)
	{
		delete[] _payload;
...
void RPCFriendsRequestRoster::FreePayload()
{
	if (_payload != NULL)
	{
		delete[] _payload;
...
RPCFriendsRequestRoster* RPCFriendsRequestRoster::Create()
{
	return new RPCFriendsRequestRoster();
}
...
rpc_message_type_s g_rpcMessageTypes[] = 
{
	...
	{ 1202, (CreateMessageCB)&RPCFriendsRequestRoster::Create },
	{ 1211, (CreateMessageCB)&RPCFriendsRosterMessage::Create },
	{ 1213, (CreateMessageCB)&RPCFriendsSetPresenceMessage::Create },
	{ 1216, (CreateMessageCB)&RPCFriendsGetUserAvatarMessage::Create },
	{ 1217, (CreateMessageCB)&RPCFriendsGetUserAvatarResultMessage::Create },
